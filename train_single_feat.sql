drop table if exists train_single_feat;
create table train_single_feat as
select 
    user_id, event_id, client_ip, network, device_sign, ip_prov, ip_city,
    card_bin_prov,card_bin_city,mobile_oper_platform,operation_channel,
    pay_scene, amt,gmt_occur,is_fraud,
    --把-1的样本改成1
...
--from atec_1000w_ins_data where gmt_occur<'2017-10-01 00' or gmt_occur>='2017-10-08 23';

--select gmt_occur,count(*) from train_single_feat where gmt_occur>'2017-09-30 00' group by gmt_occur;